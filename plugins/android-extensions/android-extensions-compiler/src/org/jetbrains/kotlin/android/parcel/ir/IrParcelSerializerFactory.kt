...
class IrParcelSerializerFactory(private val builtIns: IrBuiltIns, symbols: AndroidSymbols) {
    ...
    init {
        ...
        val charSequenceSerializer = CharSequenceSerializer()
        ...
        for (info in serializerInfos) {
            ...
            fqNameMap[fqName.parent()] =
                info.serializer to (if (info.nullable != false) info.serializer else NullAwareParcelSerializer(info.serializer))
        }
    }
